...
\chapter{Problema de caída libre}
\label{ch:caida-libre}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\section{Deducción del instante de impacto}
...
plt.annotate('Momento de impacto', 
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\linewidth]{img/guide-1/altura-vs-tiempo.png}
